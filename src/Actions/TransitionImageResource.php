...
final class TransitionImageResource
{
    ...
    public function execute(ImageResource $resource, string $teamId, string $status, array $allowedStatuses = ['draft', 'active', 'paused', 'completed', 'failed', 'cancelled']): ImageResource
    {
